  ...
  <div class="page">
    ...
    <main>
      <section class="hero">
        <div class="hero-text">
          ...
          <div class="hero-buttons">
            ...
            <button class="secondary-btn">Vezi animăluțele</button>
          </div>
        </div>
      ...
      <section class="pet-grid">
        <article class="pet-card" v-for="pet in pets" :key="pet.name">
          <div class="pet-img">
          ...
          <div class="pet-info">
            <h3>{{ pet.name }} <span>{{ pet.type }}</span></h3>
            <p>{{ pet.info }}</p>
            <small>{{ pet.tag }}</small>
          </div>
        </article>
      ...
      <section class="cta">
        ...
        <button class="dark-btn">Începe adopția 🐾</button>
      </section>
    </main>
  </div>
</template>
...
const pets = [
  ...
  },
  {
    ...
    info: "7 luni • Mascul",
    tag: "Blând 🐾",
    img: "https://images.unsplash.com/photo-1585110396000-c9ffd4e4b308?auto=format&fit=crop&w=500&q=80",
  },
  {
    name: "Rex",
    type: "Cățel",
    info: "2 ani • Talie mare",
    tag: "Loial 🐾",
...
const categories = [
  ...
  { icon: "🐰", name: "Iepurași" },
  { icon: "🦜", name: "Păsări" },
  { icon: "🐕", name: "Senior pets" },
  { icon: "💞", name: "Special care" },
];
</script>